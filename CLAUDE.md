...
├── tests/v4/                  # 34 tests — the particle substrate under proof_of_concepts/v4
...
- Tests: `pytest` from repo root — `pytest.ini` targets `tests/v3` (142) and `tests/v4` (34)
...
- Always run `pytest` after changes (176 tests must stay green)
