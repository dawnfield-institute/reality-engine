"""
Matter Analysis v3 — Full pipeline with SpinStatistics + ChargeDynamics.

Builds on v2's full-spectrum scanning with the new physics operators:
- SpinStatisticsOperator: multi-scale Pauli exclusion, degeneracy feedback
- ChargeDynamicsOperator: EM forces via Poisson potential
- Memory operator: degeneracy-aware mass generation throttling

Expected improvements over v2: more mass peaks, less cap pileup,
sharper 1/phi^2 spacing, nearly all structures bound.
"""
